...
export default async function ArtistPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!data || !data.artist) {
    return (
      <div className="min-h-screen bg-yard-dark flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-5xl font-extrabold mb-4 text-yard-gold">Artist Not Found</h1>
          <p className="text-lg mb-8 text-gray-400">The artist you're looking for doesn't exist.</p>
          <Link href="/artists">
  ...
  return (
    <div className="min-h-screen bg-yard-dark">
        ...
        <div className="w-full flex flex-col md:flex-row items-center justify-center gap-12 max-w-screen-2xl mx-auto px-4 sm:px-8">
          ...
          <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="flex flex-wrap gap-6 mb-6 justify-center md:justify-start">
              <div className="flex items-center gap-2 text-yard-gold/90">
            ...
            <div className="flex gap-4 mt-2">
              {artist.spotifyId && (
                <a
                  ...
                  className="text-yard-gold hover:text-yard-gold/80 transition-colors"
                  title="Spotify"
                >
      ...
      <section className="w-full max-w-screen-2xl mx-auto px-4 sm:px-8 py-12 grid grid-cols-1 md:grid-cols-3 gap-12">
        {/* Biography */}
        <div className="md:col-span-2 border border-[#222] bg-[#111] p-8">
          ...
          <div className="border border-[#222] bg-[#111] p-8">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-yard-gold">{artist.genres?.join(', ')}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-400">Followers</span>
                <span className="font-semibold text-yard-gold">{numberFormat(artist.followers)}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-400">Net Worth</span>
                <span className="font-semibold text-yard-gold">{currencyFormat(artist.netWorth)}</span>
              </div>
              {artist.birthPlace && (
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Origin</span>
                  <span className="font-semibold text-yard-gold">{artist.birthPlace}</span>
                </div>
              )}
            </div>
          </div>
            ...
            <div className="space-y-3">
              {artist.spotifyId && (
                ...
                >
                  ...
                  <ExternalLink className="w-4 h-4 text-yard-gold" />
                </a>
              )}
              {artist.socialMedia?.instagram && (
                <a
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-black text-white mb-6">
                Latest <span className="bg-gradient-to-r from-yard-gold to-yellow-600 bg-clip-text text-transparent">News</span> About {artist.name}
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {relatedArticles.map((article: any) => (
                <Link key={article._id || article.id} href={`/news/${article.slug || article._id}`}>
                  <Card className="group cursor-pointer border border-[#222] bg-[#111] h-full hover:scale-[1.02] transition-all duration-300">
                    <div className="aspect-video mb-4 overflow-hidden rounded-xl relative">
                      ...
                      {/* Time badge */}
                      <div className="absolute top-3 right-3 glass text-gray-300 px-2 py-1 rounded-xl text-xs font-semibold">
                    ...
                    <div className="p-6">
                      <h3 className="text-lg font-bold text-white mb-3 line-clamp-2 group-hover:text-yard-gold transition-colors">
                        {article.title}
                      </h3>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-yard-gold text-sm font-semibold flex items-center">
        ...
        <section className="py-20 bg-yard-dark">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="border border-[#222] bg-[#111] p-12">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">No Recent News</h3>
